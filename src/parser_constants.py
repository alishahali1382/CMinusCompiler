...
grammar_rules: List[GRAMMAR_RULE] = [
    ...
    (NonTerminal.Fun_declaration_prime, [Terminal.PARAENTHESIS_OPEN, NonTerminal.Params, Terminal.PARAENTHESIS_CLOSE, SemanticRoutine.SA_BEGIN_FUNCTION_STATEMENT, NonTerminal.Compound_stmt, SemanticRoutine.SA_CALEE_WORKS]), # TODO: add something to the end that returns to the caller, except for main
    ...
    (NonTerminal.Params, [SemanticRoutine.SA_BEGIN_PARAM, Terminal.INT, SemanticRoutine.SA_TYPE_SPECIFIER_INT, Terminal.ID, SemanticRoutine.SA_ASSIGN_PARAM, NonTerminal.Param_prime, NonTerminal.Param_list]), #Ok
    (NonTerminal.Params, [Terminal.VOID]), #Ok
    (NonTerminal.Param_list, [Terminal.COMMA, SemanticRoutine.SA_BEGIN_PARAM, NonTerminal.Param, NonTerminal.Param_list]), #maybe cause duplicate type specifier #TODO
    (NonTerminal.Param_list, [Terminal.EPSILON]), #Ok
    (NonTerminal.Param, [NonTerminal.Declaration_initial, SemanticRoutine.SA_ASSIGN_PARAM, NonTerminal.Param_prime]), #Ok
    (NonTerminal.Param_prime, [SemanticRoutine.SA_DECLERATION_ROLE_ARRAY, Terminal.BRACKET_OPEN, Terminal.BRACKET_CLOSE]), #Ok
    (NonTerminal.Param_prime, [Terminal.EPSILON]), #Ok
